...
- API commands for line-level comments:
  ...
  - `gh api repos/OWNER/REPO/pulls/PR_NUMBER/comments --method POST --field body="🤖 **OpenCode here!** [reply text]" --field in_reply_to=COMMENT_ID` - Reply to line comment (identify as OpenCode)

## Continuous Improvement
OpenCode should proactively suggest updates to AGENTS.md files (both personal and project-specific) when discovering:
